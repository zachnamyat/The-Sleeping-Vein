...
- **Phase**: Phase 0/1/2/3/4/5 closed in full. Phase 5 critical-path + full-backlog closure landed 2026-05-15 — Glaur-em fight (3-phase + arena gate-lock + procedural attack telegraph + 240s enrage + defeat fanfare); NpcDirector cinematic arrivals + paper-bird from the Loom; CompendiumPanel grew Relics + Titles tabs; new autoloads TutorialDirector / BarkSystem / TitleSystem; new structures bed / shrine / healing_shrine / spike_trap / hidden_door / mural / trial_chamber; new FX boss_telegraph / paper_bird / glaurem_carving; new UI boss_intro_crawl / boss_prep_panel / opening_sequence. Migrations 2.34 photograph + 3.40 recipe_scroll + 3.70 glaurem_trinket + 3.72 recipe-scroll-from-chest also shipped. **Zero Phase 5 backlog remains.** Phase 4 retained: WorldGen still does noise-based walls, BFS ore veins, procedural rooms / lakes / camps / lore tablets / treasure chests / mob spawners / sub-biome detection / world border. (Ticket 4.6 corridor carving was retracted 2026-05-14 — anti-parity.) Bed sleep gated by hostiles + cooldown + 24-min skip_time. SaveSystem v4 persists explored_chunks + respawn_point. **Zero Phase 4 backlog remains.**
...
- **Tests**: 74/74 GUT tests pass (combat math, health, manifest loader, skill xp, save system, inventory, loot table, crafting flow, equipment validation, chest persistence, stack split + sort, world-gen determinism + corridor predicate, explored-chunks save round-trip, Phase 5 systems: first-kill compendium / titles / bark / recipe-scroll / arena gate / boss drops). CI runs on push via `.github/workflows/test.yml`.
- **Autoloads**: 23 — gameplay (GameState, EventBus, SaveSystem, AudioBus, SkillSystem, ItemRegistry, Inventory, MiningSystem, CraftingSystem, NpcDirector, Compendium, BossDirector, NetSystem, FarmingSystem, Buffs, BiomeHazard, Achievements, FishingSystem, Housing, CombatFeel, WorldEvents, CrystalRegrowth, TutorialDirector, BarkSystem, TitleSystem) + infra (I18n, Settings).
- **Recent decisions**:
