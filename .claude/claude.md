...
- **Tests**: 113/113 GUT tests pass (combat math, health, manifest loader, skill xp, save system, inventory, loot table, crafting flow, equipment validation, chest persistence, stack split + sort, world-gen determinism + corridor predicate, explored-chunks save round-trip, Phase 5 systems, Phase 6 combat depth, Phase 7 talent trees + presets + set bonuses + reforge + luck + mob affixes + XP buffs + accessory skills + skill challenges). CI runs on push via `.github/workflows/test.yml`.
- **Autoloads**: 27 — gameplay (GameState, EventBus, SaveSystem, AudioBus, SkillSystem, TalentRegistry, ItemRegistry, Inventory, MiningSystem, CraftingSystem, NpcDirector, Compendium, BossDirector, NetSystem, FarmingSystem, Buffs, BiomeHazard, Achievements, FishingSystem, Housing, CombatFeel, PlayerStats, LuckSystem, SkillChallenges, CombatTracker, WorldEvents, CrystalRegrowth, TutorialDirector, BarkSystem, TitleSystem, DevConsole) + infra (I18n, Settings).
- **Recent decisions**:
